...
draft: false
hero:
  src: "/images/insights/nice-template-no-trust-hero.jpg"
  alt: "Savelle McThias pinning real workplace photos to a board beside a laptop showing a generic stock-photo site"
cta:
  heading: "Score the signals your site is sending"
  text: "The free UX Health Check reads your site the way a skeptical first-time visitor does — clarity, conversion, mobile, accessibility, and consistency — and returns a 0–100 score with your three highest-priority fixes. Two minutes, no sales call attached."
...
<img src="/images/insights/nice-template-no-trust-body.jpg" alt="A real work crew standing by their service van at golden hour" class="rounded-2xl my-10" loading="lazy" />
