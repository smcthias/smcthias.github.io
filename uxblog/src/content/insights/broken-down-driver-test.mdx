...
draft: false
hero:
  src: "/images/insights/broken-down-driver-test-hero.jpg"
  alt: "An auto repair shop glowing at dusk with one bay open and a car with hazard lights waiting outside"
cta:
  heading: "Would your site pass the 30-second test?"
  text: "The free UX Health Check scores your site the way a stressed driver experiences it — clarity, conversion paths, mobile, accessibility, and consistency. Two minutes, an instant 0–100 score, and your three highest-priority fixes."
...
- **Real reviews, with detail.** One specific story — "they showed me the worn rotor and quoted less than the dealer" — outweighs twenty generic five-star blurbs. Put your rating and count next to the call button, [where the decision happens](/insights/nice-template-no-trust).
...
<img src="/images/insights/broken-down-driver-test-body.jpg" alt="A service advisor handing car keys back to a relieved customer at a warm shop counter" class="rounded-2xl my-10" loading="lazy" />
...
- **Hours, address, and a tap-to-call button** that a shaking hand can hit on the first try. If [your mobile experience](/insights/mobile-reality-check) makes her pinch and zoom to find the phone number, the shop with the big green button gets the tow.
